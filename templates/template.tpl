        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="#" class="waves-effect waves-dark"><i class="fa fa-user"></i> Realizar Ciclo <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?= base_url('realizarciclo')?>">Novo</a>
                            </li>
                            <li>
                                <a href="<?= base_url('realizarciclo/listar')?>">Lista</a>
                            </li>
                        </ul>
                    </li>
